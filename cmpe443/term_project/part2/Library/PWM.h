...
#define IOCON_LED_ADDRESS_1	0x4002C088	//P1.2(P30)
#define IOCON_LED_ADDRESS_2	0x4002C08C	//P1.3(P29)
#define IOCON_LED_ADDRESS_3	0x4002C094	//P1.5(P28)
#define IOCON_LED_ADDRESS_4	0x4002C098	//P1.6(P27)
